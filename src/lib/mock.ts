...
export const mockPaymentOrders: PaymentOrder[] = [
  {
    ...
    pix_qr_code: null,
    pix_copy_paste: '00020126580014BR.GOV.BCB.PIX0136pix-demo-3deventos5204000053039865405400.005802BR5920Douglas 3DEventos6009SaoPaulo62070503***6304ABCD',
    checkout_type: 'pix',
    qr_code_base64: '',
    amount: 400,
    status: 'pending',
...
export const mockDashboardSummary: DashboardSummary = {
  ...
  confirmedRevenue: mockReservations.filter((item) => item.status === 'reservado').reduce((sum, item) => sum + Number(item.entry_amount ?? item.total_amount ?? 0), 0),
  averageTicket: 950,
  availableDays: 22,
  bookedDays: 8,
}
